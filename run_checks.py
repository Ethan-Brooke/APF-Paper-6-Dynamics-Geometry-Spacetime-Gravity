...
This is the standalone-repo verifier for Dynamics Geometry Spacetime Gravity (APF Paper 6).
...
verifies the 22-theorem subset directly cited by the manuscript.
"""
...
def main():
    ...
    print()
    print("=" * 72)
    print(f"  Paper 6 ({{Dynamics Geometry Spacetime Gravity}}): {passed} passed, {failed} failed, "
