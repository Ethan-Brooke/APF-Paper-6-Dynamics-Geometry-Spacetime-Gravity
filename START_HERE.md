...
You are reading the companion to **Paper 6** (this repo: https://github.com/Ethan-Brooke/APF-Paper-6-Dynamics-Geometry-Spacetime-Gravity). The canonical computational engine lives at codebase **v6.9** ([Zenodo](https://doi.org/10.5281/zenodo.18604548)). Each paper has its own companion repo following the same layout.
