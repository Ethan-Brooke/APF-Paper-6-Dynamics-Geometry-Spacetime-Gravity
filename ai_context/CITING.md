...
> Brooke, E. S. (2026). *Dynamics and Geometry as Optimal Admissible Reallocation*. Version v2.0-PLEC. Zenodo. https://doi.org/10.5281/zenodo.18439445

**BibTeX:**

```bibtex
@misc{brooke_paper6_2026,
  ...
  url          = {https://doi.org/10.5281/zenodo.18439445}
}
```

The DOI `10.5281/zenodo.18439445` is the concept DOI; it resolves to the latest version. Specific versions have their own version-DOIs (see the Zenodo record).
