...
> Brooke, E. S. (2026). *Dynamics and Geometry as Optimal Admissible Reallocation*. Version v2.0-PLEC. Zenodo. https://doi.org/10.5281/zenodo.18604874
...
The DOI `10.5281/zenodo.18604874` is the concept DOI; it resolves to the latest version. Specific versions have their own version-DOIs (see the Zenodo record).
