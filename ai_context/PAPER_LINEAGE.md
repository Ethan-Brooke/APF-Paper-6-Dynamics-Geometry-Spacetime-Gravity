# PAPER_LINEAGE.md — Version History for Paper 6

This file tracks the version history of Paper 6 (Dynamics and Geometry as Optimal Admissible Reallocation) and explains the relationship between the version in this release, the version on Zenodo, and any intermediate versions.

---

## Current release

- **Version in this repo:** v2.0-PLEC
- **File in this repo:** `Paper_6_Dynamics_Geometry_Spacetime_Gravity_v2.0-PLEC.tex` + `.pdf`
- **Page count:** None pp
...
- **Concept DOI:** 10.5281/zenodo.18439445
...
- **v2.0-PLEC** (current): see the main paper's changelog section for details.
...
**vv2.0-PLEC supersedes all earlier versions** for current reference. If citing for strict reproducibility of work published before this version, cite the version DOI from the specific Zenodo deposit the earlier work used.
...
*Generated by `create-repo`. The `- **v2.0-PLEC** (current): see the main paper's changelog section for details.
